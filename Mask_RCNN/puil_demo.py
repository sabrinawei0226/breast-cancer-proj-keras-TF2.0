...
# Import COCO config
sys.path.append(os.path.join(ROOT_DIR, "C:/pythonwork/shuo/Mask_RCNN-master/"))  # To find local version
print(ROOT_DIR)
...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "C:/pythonwork/shuo/Mask_RCNN-master/logs/mask_rcnn_catvsdog_0030.h5")
