...
class MaskRCNN():
    ...
    def compile(self, learning_rate, momentum):
        ...
        ####optimizer = keras.optimizers.Adam(lr=learning_rate, beta_1=0.9, beta_2=0.999, epsilon=None, decay=learning_rate/200, clipnorm=self.config.GRADIENT_CLIP_NORM)
...
class MeanAveragePrecisionCallback(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch > 2 and (epoch+1)%self.calculate_map_at_every_X_epoch == 0:
            ...
            mAPs = self._calculate_mean_average_precision(epoch)
            mAP = np.mean(mAPs)
    ...
    def _calculate_mean_average_precision(self, epoch):
        mAPs = []
        precisions = []
        mRs = []
        ...
        plt.savefig("../../pupil_test_im3/conclusion/p-r_figure/%3s.jpg"%(str(epoch)))
        '''
